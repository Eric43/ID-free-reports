...
```{r, Plotting entire NY times data set}
...
```{r, Time-series using just one state}
...
```{r, Time series plot using log for y axis}
...
```{r, Random Walk Forecasting model}
...
```{r, setting up the difference model with forecast}
